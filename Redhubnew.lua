-- RED HUB (Complete with all hooks)
pcall(function()
    ...
    -- TABS MỚI
    local PlayerTab = Window:CreateTab("👤 Người Chơi", "rbxassetid://4483345998")
    local ServerTab = Window:CreateTab("🌐 Server", "rbxassetid://4483345998")
    local CombatTab = Window:CreateTab("⚔️ Chiến Đấu", "rbxassetid://4483345998")
    local VisualTab = Window:CreateTab("👁️ Đồ Họa", "rbxassetid://4483345998")
    local FunTab = Window:CreateTab("🎉 Vui Vẻ", "rbxassetid://4483345998")
    ...
    Rayfield:Notify({
        Title = "Red Hub",
        Content = "Menu đã tải thành công! Tabs đã được sắp xếp lại.",
        Duration = 6,
    })

    print("✅ Red Hub loaded với đầy đủ hooks và tabs mới!")
end)
